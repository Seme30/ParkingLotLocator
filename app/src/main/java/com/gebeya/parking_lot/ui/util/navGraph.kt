...
import com.gebeya.parking_lot.ui.screens.RegisterProviderScreen
...
//
        ...
        composable(route = Screen.RegisterProvider.route){
            RegisterProviderScreen(navController = navController)
        }
    }
