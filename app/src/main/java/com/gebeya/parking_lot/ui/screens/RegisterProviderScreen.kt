...
import com.gebeya.parking_lot.viewmodel.RegisterFormViewModel
import com.gebeya.parking_lot.viewmodel.RegisterProviderViewModel
...
fun RegisterProviderScreen(navController: NavHostController
    ...
    val registerFormViewModel = hiltViewModel<RegisterProviderViewModel>()
